...
const INPUT_P2_3x3 = @embedFile("inputs/day21_3x3.txt");
const INPUT_P2_5x5 = @embedFile("inputs/day21_5x5.txt");
...
pub fn main() !void {
    ...
    {
        const result = try part1(INPUT_P2_3x3, 65 + 131);
        try stdout.print("Part 1: {}\n", .{result.part1});
    }

    // {
    //     const result = try part1(INPUT_P2_5x5, 65 + 131 + 131);
    //     try stdout.print("Part 1: {}\n", .{result.part1});
    // }
}
...
fn part1(input: []const u8, steps: usize) !struct { part1: i64, part2: i64 } {
    var map_buffer = [_]Cell{.rock} ** (1500 * 1500); // Approx correct size
